...
public:
    ...
    void processBinaryOperator(const clang::BinaryOperator* op, const std::string& op_code, const std::string& op_type_name, long long multiplier, const clang::SourceManager& source_manager);
    void processUnaryOperator(const clang::UnaryOperator* op, const std::string& op_code, const std::string& op_type_name, long long multiplier, const clang::SourceManager& source_manager);
